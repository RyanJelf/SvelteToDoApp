<!-- this is the section where each component is imported into.  -->
<script>
...
<div class="min-h-screen bg-olive-one p-0 selection:bg-green-two md:py-24 md:px-8">
	...
	>
		<h1 class="text-2xl font-bold text-olive-three">
			Simple to do list app in Sveltekit using Tailwind
		</h1>
		<div class="mt-10">
			<AddTodoSection />
			<TodoSection />
